export const metadata = {
  title: "Rates – Katherine Taylor Escort Experiences in San Francisco & Sacramento",
  description:
    "Dinner Engagements – Elegant Evenings with Katherine Taylor. Overnight Arrangements – Unhurried Time in Sacramento. Weekend Escapes – Travelable Companionship If I Don't Pop Up When You Search 'Escorts Near Me'. Rates reflect the quality of time—not just its length. Each arrangement is tailored to your preferences.",
};
